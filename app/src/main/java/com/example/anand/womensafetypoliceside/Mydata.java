...
public class Mydata {
    ...
    public static String recdangerlocation() {
        final String SERVER_URL = "http://192.168.43.86:80/ws/recdangerlocation.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
...
//            Toast.makeText(null,ex.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public static String updatestatus(String latitude,String longtitude){
        final String SERVER_URL = "http://192.168.43.86:80/ws/updatestatus.php"; // The server(Servlet) which will process the request. Note 10.0.2.2 is the localhost IP for emulator
        final String CHAR_SET = "UTF-8"; // Encoding used for the parameters
        OutputStream output = null;
        String response = "";
